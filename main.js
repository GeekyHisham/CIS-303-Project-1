...
function resetForm() {
    document.forms['solarForm'].reset(); // Resets all form fields to their initial values
    document.getElementById('feedback').innerHTML = '<p>Enter your information above to calculate your solar needs.</p>'; // Resets the feedback area
}
